...
REDCap can export to the following formats: comma-delimited; SPSS; SAS; R; Stata; and XML. 
...
5. Designate data collection instruments to be administered at each stud event
