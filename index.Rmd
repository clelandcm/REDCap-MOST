...
### Days-offset
Days-offset is part of defining events for an arm.  It specifies the “ideal” time for an activity as well as a range during which the activity can be completed.  Implicitly, days-offset also specifies the order in which events for an arm will take place.  
...
Each event can be connected with one or more data collection instruments to be completed during the event.  
