...
After screening may be a good time to generate a schedule for an eligible and enrolled participant.  Schedule generation is arm-specific.  The schedule can be modified over time to accomodate rescheduling and no-shows.
