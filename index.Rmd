...
|:---------:|:-------:|:-----------:|:-------------:|:--------------:|
| 1         | tuna    | 20min       | Yes           |  Yes           |
| 2         | salmon  | 20min       | Yes           |  No            |
| 3         | marlin  | 20min       | No            |  Yes           |
| 4         | bass    | 20min       | No            |  No            |  
| 5         | trout   | 3min        | Yes           |  Yes           |  
| 6         | shark   | 3min        | Yes           |  No            |  
| 7         | carp    | 3min        | No            |  Yes           |  
| 8         | halibut | 3min        | No            |  No            |  
...
![**Figure 6**. Defining Events](Screenshot 2018-08-20 11.47.21.png)
  
Each **arm** in the project is a collection of events in a sequence.  For study conditions which receive multiple components, consider the order in which those components will be delivered to participants, and whether temporal overlap among components is permissible or not.  
...
![**Figure 1**. Manual Data Export within REDCap](Screenshot 2018-08-20 11.34.24.png)
...
3. condition-specific events which utilize schedules tailored to individual study conditions and record information related to the intervention activities in each study condition
