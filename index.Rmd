...
As you prepare to set up REDCap to manage a study, it can be useful to create a table showing the study conditions and which levels of each component they receive. Giving the study conditions names, rather than referring to them only with numbers or letters, can make it easier for staff to think about and discuss to activities needed for specific conditions. Consider a 2*2*2 full factorial design. A table to guide REDCap setup may look something like this:



In this example, study conditions are given animal names. With more than 16 conditions, names may not be helpful/feasible.
...
It is very likely you will want and need to do things with the collected data that are impossible or difficult to do within the REDCap system. A fairly efficient approach is the regularly export data from REDCap, and then generate the 
