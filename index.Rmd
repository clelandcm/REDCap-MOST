...
### Days-offset
Days-offset is part of defining events for an arm.  It specifies the “ideal” time for an activity as well as a range during which the activity can be completed.  Implicitly, days-offset also specifies the order in which events for an arm will take place.  [Defining Longitudinal Events (5 min)](blob:https://redcap.vanderbilt.edu/798d480c-4eb5-4c1b-a2b0-d5a6641fc06d)


### Designating Instruments for Events
Each event can be connected with one or more instruments to be completed during the event.  [Designating Instruments for Events (3 min)](blob:https://redcap.vanderbilt.edu/22234cea-4658-4bb6-879b-5c644a0536fb)
